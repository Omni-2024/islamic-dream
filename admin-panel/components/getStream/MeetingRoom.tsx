            ...
            {[...Array(6)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    "radial-gradient(circle, rgba(12,130,129,0.3) 0%, transparent 70%)",
        ...
        <div className="relative max-w-xl w-full bg-gradient-to-br from-[#FF6961] via-[#0C8281] to-red-900 rounded-2xl ">
          ...
          <div className="absolute -top-20 left-1/2 transform -translate-x-1/2">
            <div className="relative">
              ...
              <div className="animate-ping absolute inset-0 rounded-full bg-red-500 opacity-30 delay-150" />
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-[#0C8281]/20">
            <div className="text-center space-y-6 mt-8">
              ...
              <div className="flex justify-center">
                <div className="h-1 w-24 bg-gradient-to-r from-transparent via-[#0C8281] to-transparent animate-pulse" />
              </div>
