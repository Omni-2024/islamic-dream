            ...
            {!otpSent ? (
              ...
              <form onSubmit={handleOtpVerify} className="space-y-8  w-[250px] md:w-[350px] lg:w-[400px]">
                ...
                <div className="flex justify-center gap-3 ">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      className="w-8 h-8 md:w-11 md:h-11 md:mx-2 mx-1 !border !border-gray-300 text-center text-lg font-bold rounded-md focus:outline-none focus:ring-2 focus:RuqyaDarkGreenring-"
                ...
                <Button
                  ...
                  color={"RuqyaGreen"}
                  disabled={loading}
                  className="w-full bg-RuqyaGreen hover:bg-RuqyaGreen/80 text-white rounded-full py-3 mt-5"
                />
              </form>
            )}
